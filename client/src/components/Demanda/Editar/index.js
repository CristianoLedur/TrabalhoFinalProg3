...
export default function EditarDemanda({ demandaSelecionada, closeModal }) {
                            ...
                            {demandaSelecionada.tipoDemanda === 'sugerida' ? (
                                <div className="grid gap-4 mb-4 sm:grid-cols-2">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            defaultValue={demandaSelecionada.titulo}
                                            required="" 
                                        />
                                    </div>
                                    <div className="sm:col-span-2">
                                        ...
                                        <textarea 
                                            defaultValue={demandaSelecionada.descricao}
                                            id="descricao" 
                                            rows="4" 
                                            className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
                                            placeholder="Escreva uma descrição sobre a atividade"
                                        >
                                    ...
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            defaultValue={demandaSelecionada.diasEturnos}
                                            required="" 
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            required="" 
                                            min={0} 
                                            defaultValue={demandaSelecionada.quantidadeInteressados}
                                        />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <button 
                                            onClick={handleBoxCidades}
                                            id="dropdownBgHoverButton" 
                                            data-dropdown-toggle="dropdownBgHover" 
                                            className="text-white bg-blue-700 w-auto hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" 
                                            type="button"
                                        >
                                            Cidades 
                                        ...
                                        <div 
                                            id="dropdownBgHover" 
                                            className={toggleBoxCidades 
                                                ? "z-10 w-48 bg-white rounded-lg shadow dark:bg-gray-700"
                                                : "hidden"
                                            }
                                        >
                                ...
                                <div className="grid gap-4 mb-4 sm:grid-cols-2">
                                    ...
                                    <div className="sm:col-span-2">
                                        ...
                                        <textarea 
                                            defaultValue={demandaSelecionada.observacao}
                                            id="observacao" 
                                            rows="4" 
                                            className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
                                    ...
                                    <div>
                                        ...
                                        <select id="cidade" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                            <option selected="">Selecione uma opção</option>
