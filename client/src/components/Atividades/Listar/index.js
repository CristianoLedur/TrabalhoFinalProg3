...
export default function ListarAtividade({ openModal, data, fetchAtividade, isLoading }) {
    ...
    const handleRowClick = (itemId) => {
        // Chamar a função fetchAtividade passando o ID da atividade selecionada
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                        <div className="w-full md:w-1/2">
                            <form className="flex items-center">
                                <label htmlFor="simple-search" className="sr-only">Procurar por atividade...</label>
                                <div className="relative w-full">
                                    ...
                                    <input type="text" id="simple-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Procurar por atividade..." required=""/>
                                </div>
                            </form>
                        </div>
