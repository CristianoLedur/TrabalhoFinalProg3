...
export default function CadastrarAtiviade({ closeModal }) {
                    ...
                    >
                        <div className="grid gap-4 mb-4 sm:grid-cols-2">
                            <div>
                                ...
                                {atividadeCadastrada && (
                                    <p className="mt-2 text-sm text-red-600 dark:text-red-500">{atividadeCadastrada}</p>
                                )}
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    type="numer" name="quantidadeVagas" id="quantidadeVagas" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
