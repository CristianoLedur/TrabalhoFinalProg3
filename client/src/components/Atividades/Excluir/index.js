...
export default function ExcluirAtiviade({ atividadeSelecionada, closeModal }) {
    const handleDestroyAtividade = async () => {
            ...
            <div className="relative w-full max-w-md max-h-full">
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="p-6 text-center">
                        ...
                        <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Você tem certeza de que deseja excluir esta atividade?</h3>
                        <button 
                            onClick={handleDestroyAtividade}
