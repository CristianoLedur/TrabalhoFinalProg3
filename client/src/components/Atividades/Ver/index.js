...
export default function VerAtiviade({ atividadeSelecionada, handleButtonSugerir, closeModal }) {
    ...
    const [ backendDemandas, setBackendDemandas ] = useState([{}]);
                ...
                <div className="relative p-4 w-full max-w-xl h-full md:h-auto">
                    ...
                    <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        ...
                        <dl>
                            ...
                            {/* {atividadeSelecionada.cidadeId.map((cidade, i) => (
                                <dd className="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{cidade.nome}</dd>
                            ))} */}
                        </dl>
